<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="index.html" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2">Sistem Laundry</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item">
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item">
                    <a href="view/level.php" class="menu-link">
        ...
        <li class="menu-item">
            ...
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="view/dataTransaksi.php" class="menu-link">
                        <div data-i18n="Basic">Data Transaksi</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="view/transaksiPengembalian.php" class="menu-link">
                        <div data-i18n="Basic">Transaksi Pengembalian</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="view/laporanTransaksi.php" class="menu-link">
